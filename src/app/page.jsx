        ...
        <div className="h-screen flex flex-col justify-evenly">
          ...
          <div className="flex flex-row">
            ...
            <div className="w-2/3 space-y-8">
              ...
              <a href="" className="p-0 items-center justify-start text-[#E0A701] text-xl w-fit flex flex-row relative after:bg-[#E0A701] after:absolute after:h-[1px] after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300">
                Read More{" "}
                <svg
                  className="w-6"
                  xmlns="http://www.w3.org/2000/svg"
